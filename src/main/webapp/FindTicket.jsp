...
<%
	...
	if(totalSeat != null && date != null && destination != null && actionType.equals("search"))
	{
		...
		<div class="ticket_info">
			...
			<table class="table">
				<tr>
					...
					<td>
						<ul>
							<li><strong>Bus / Number</strong> <span><%= tickDetails.get("bus_name") %></span></li>
							<li><strong>Class/Coach</strong> <span><%= tickDetails.get("bus_type") %></span></li>
		...
		if(isError){
			...
			String bookedId =String.valueOf(booking.BookNow(destObj, userId, date, totalSeat));
			request.setAttribute("bookingid", bookedId);
		%>
		<div class="ticket_info">
		...
		<jsp:include page="PrintTicket.jsp">
        	<jsp:param name="bookingid" value='${bookedId}'/>
    	</jsp:include>
		<%
		}
	}
